...
export default function Home() {
  ...
  const showGreeting = () => {
    ...
    <div className="min-h-screen bg-yellow-100 w-full md:py-8 text-xl font-serif">
      <div className="py-8 mx-auto max-w-3xl border-white border-2 rounded-lg bg-white shadow">
        ...
        <div className="leading-snug max-w-2xl px-8 md:px-16">
...
<span onClick={ () => setReveal("ucuenca")} className="font-bold underline cursor-pointer bg-yellow-100 hover:bg-yellow-200">
        ...
        <div className="leading-snug mt-4 max-w-2xl px-8 md:px-16">
        ...
        <div className="leading-snug mt-4 max-w-2xl px-8 md:px-16 pb-4">
